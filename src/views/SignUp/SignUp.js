    ...
    if (validate()) {
      try {
        ...
        if (responces.data.success) {
          ...
          const res = await Client.post("/requestEmailVerification", { email: responces.data.message.email });
          return res;
        } else {
  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      >
        ...
        <Avatar sx={{ m: 1, backgroundColor: "#112c48" }}>
          <LockOutlinedIcon sx={{ color: "#87ceeb" }} />
        </Avatar>
        <Typography component="h1" variant="h5">
          <div className="line2nd">
            <span style={{ color: "#87ceeb" }}>Index</span>
            <span style={{ color: "#112c48" }}>Cloud</span>
          </div>
        </Typography>
        <Typography component="h1" variant="h5">
          Sign up
      ...
      <form className="form">
        <Grid container spacing={2} className="field">
          ...
          <Input name="mobile_no" label="Contact number" handleChange={handleChange}/>
          <Input name="street" label="Street address" handleChange={handleChange}/>
          <Input name="city" label="City" handleChange={handleChange} half />
          <Input name="district" label="District" handleChange={handleChange} half />
        ...
        <Button
          ...
          color="primary"
          className="submit"
          sx={{ marginTop: "20px", backgroundColor: "#001E3C" }}
